...
class DiaForm(forms.ModelForm):
    ...
    class Meta:
        model = Dia
        fields = ["ejercicios"]
        labels = {"ejercicios": _("Ejercicios")}
...
class VentaForm(forms.ModelForm):
    class Meta:
        ...
        labels = {"medio_pago": _("Medio de pago"), "num_tarjeta": _("Número de tarjeta")}
        widgets = {"medio_pago": forms.Select(), "num_tarjeta": forms.NumberInput()}
